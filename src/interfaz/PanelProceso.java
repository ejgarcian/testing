...
public class PanelProceso extends javax.swing.JPanel {
     ...
     */
    public PanelProceso(int MAR_status, int PC_status, int process_id, String process_name, String process_status) {
        initComponents();

        this.MARS_status.setText(String.valueOf(MAR_status));
        this.PC_status.setText(String.valueOf(PC_status));
